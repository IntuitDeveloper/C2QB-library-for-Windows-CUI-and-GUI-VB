...
Public Class QbConnect
    ...
    Private Const _tempProtocol As String = "https://"
    Private Const _tempHost As String = "www.example.com"
    Private _requestToken As IToken
    Private _qbResponse As QbResponse = New QbResponse
    ...
    Private Async Sub ProcessAuthAsync()
        If _qbConfiguration IsNot Nothing Then
            ...
            Dim r As QbResponse = Await StartOAuthHandshake(_qbConfiguration)
    ...
    Private Async Function StartOAuthHandshake(objectType As QbConfig) As Task(Of QbResponse)
        ...
        Dim r As QbResponse = Await redirectToIppForUserAuthorization(_requestToken, objectType)

        Return r
    End Function
    Private Function getOauthRequestTokenFromIpp(objectType As QbConfig) As IToken
    ...
    Private Async Function redirectToIppForUserAuthorization(requestToken As IToken, objectType As QbConfig) As Task(Of QbResponse)
        ...
        Dim r As QbResponse = Await WinSys(navigateUrl, objectType)

        Return r
    End Function

    Private Async Function WinSys(url As String, qbConfig As QbConfig) As Task(Of QbResponse)
        Dim r As QbResponse = Await WinApiAsync(url, qbConfig)
